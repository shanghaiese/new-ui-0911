ddescribe('vms controller', function() {
	...
	describe('with the given vmid number', function() {
		...
		//after loading, that.VMs contains 2 vms in an array
		it('should that.VMs be array', function() {
		...
		it('should vmTemp be equal to the fakeData', function() {
			expect(ctrl.vmTemp.id).toMatch("3633301");
		});
